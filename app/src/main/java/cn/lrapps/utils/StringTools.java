...
public class StringTools
{
	...
	public static String getTimeDate(long tm)
	{
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String str = format.format(new Date(tm));
	...
	public static String convertToRmb(int rmb)
	{
		String result = String.format("%.2f", ((double) rmb) / 100);
		return result;
	}
