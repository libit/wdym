...
public class HttpTools
{
	...
	{
		LogTools.debug(TAG + " doGet", "RELEASE_URL GET:" + url);
		...
		LogTools.debug(TAG + " doGet", "strResult:" + strResult);
		return strResult;
	}
	...
	{
		LogTools.debug(TAG + " doPost", "POST RELEASE_URL:" + url);
		String strResult = null;
		...
		for (String key : map.keySet())
		{
			...
			LogTools.debug(TAG + " doPost", "key:" + key + ",value:" + map.get(key) + ".");
		}
		try
		{
		...
		LogTools.debug(TAG + " doPost", "strResult:" + strResult);
		return strResult;
	}
