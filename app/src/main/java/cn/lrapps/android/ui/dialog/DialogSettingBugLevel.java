...
public class DialogSettingBugLevel extends Dialog implements OnClickListener
{
	...
	private void initView()
	{
		...
		if (views != null && views.size() > 0)
		{
			...
			{
				//                final TextView tvContent = (TextView) views.get(i).findViewById(R.id.tv_name);
				//                ((RadioButton) views.get(i).findViewById(R.id.rb_level)).setChecked(tvContent.getText().toString().equals(level));
			}
		}
	}
