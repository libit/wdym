...
public class FragmentMakerList extends MyBasePageFragment implements IAjaxDataResponse
{
	private static final String TAG = FragmentMakerList.class.getSimpleName();
	...
	public FragmentMakerList()
	{
	}

	public static FragmentMakerList newInstance()
	{
		return new FragmentMakerList();
	}
	...
	synchronized public void loadMoreData()
	{
		...
		mUserService.getUserFansList(null, true, mDataStart, getPageSize(), tips, true);
	}
	...
	synchronized private void refreshUserInfoList(List<UserInfo> userInfoList)
	{
		...
		if (mUserAdapter == null)
		{
			final Context context = FragmentMakerList.this.getContext();
